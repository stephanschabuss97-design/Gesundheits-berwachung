...
| `app/modules/doctor/index.js` | Rendert den Trendpilot-Hinweisblock, ruft `fetchSystemCommentsRange`, erlaubt Statusbuttons („geplant“, „erledigt“, „zurücksetzen“), loggt Fehler. |
| `app/modules/charts/index.js` & `app/modules/charts/chart.css` | Zeichnen Trendpilot-Hintergrundbänder auf dem BP-Chart, ergänzen Legende. |
